...
export class HelpComponent implements OnInit {
  ...
  createFormGroup(){
    return new FormGroup({
      ...
      country_id: new FormControl('',[Validators.required, Validators.minLength(3)]),
  ...
  onSaveForm(){
    ...
    this.bymiaService.sendContactForm(this.messages).subscribe(  res => console.log(res))
    this.onResetForm()
  }

  get name(){return this.contactForm.get('name')}
  get country_id(){return this.contactForm.get('country_id')}
